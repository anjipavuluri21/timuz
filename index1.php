...
<body>
    ...
    <div class="page-wrapper">
            ...
            <nav class="header-navigation stricky">
                <div class="container">
                    ...
                    <div class="main-nav__logo-box">
                        <a href="index1.php" class="main-nav__logo">
                            <img src="assets/images/timuz_logo.png" width="150" alt="Timuz Image" />
                        </a>
                ...
                <div class="row">
                    <div class="col-lg-7">
                        <div class="banner-one__content">
                            <p class="banner-one__tag-line">Dreams Come true</h3>
                            <p>Our dreams is to make timuz a trusted brand for games with  a high entertainment quotient</p>
                            <div class="store">
                            <a href="#"><img src="assets/images/Playstore.png"></a>   <a href="#"><img src="assets/images/Appstore.png"></a>
                            </div>
        ...
        <secti  on class="service-one" id="features">
            <div class="container">
                ...
                <div class="row">
                    <div class="service-one__col wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="000ms">
                        <div class="service-one__single">
                            <img src="E:\Web sites\zimed\files\assets\images\Game category\action.png" alt="action game">
                            <h3>Action</h3>
                        </div><!-- /.service-one__single -->
                    </div><!-- /.service-one__col -->
                    <div class="service-one__col wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="100ms">
                        <div class="service-one__single">
                            <img src="E:\Web sites\zimed\files\assets\images\Game category\Racing.png" alt="racing game" height="111px" width="111px">
                            <h3>Racing</h3>
                        </div><!-- /.service-one__single -->
                    </div><!-- /.service-one__col -->
                    <div class="service-one__col wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="200ms">
                        <div class="service-one__single">
                            <img src="E:\Web sites\zimed\files\assets\images\Game category\Casual.png" alt="Casual game" height="111px" width="111px">
                            <h3>Casual</h3>
                        </div><!-- /.service-one__single -->
                    </div><!-- /.service-one__col -->
                    <div class="service-one__col wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="300ms">
                        <div class="service-one__single">
                            <img src="E:\Web sites\zimed\files\assets\images\Game category\Puzzle.png" alt="Puzzle game" height="111px" width="111px">
                            <h3>Puzzle</h3>
                        </div><!-- /.service-one__single -->
                    </div><!-- /.service-one__col -->
                    <div class="service-one__col wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="400ms">
                        <div class="service-one__single">
                            <img src="E:\Web sites\zimed\files\assets\images\Game category\Skill.png" alt="Skill game" height="111px" width="111px">
                            <h3>Skill</h3>
                        </div><!-- /.service-one__single -->
                    </div><!-- /.service-one__col -->
                </div><!-- /.row -->
        ...
        <section class="cta-two">
            ...
            <div class="container">
                ...
                <img src="assets/images/mocs/cta-moc-2-1.png" alt="" class="cta-two__moc">
                <div class="row">
                    <div class="col-xl-5 col-lg-6">
                        <div class="cta-two__content">
                            ...
                            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry when an unknown printer
                                took a galley of type and scrambled it to make. Lorem ipsum dolor sit amet, consectetur
                                adipisicing elit.</p>
                            <a href="#" class="thm-btn cta-two__btn">Discover More</a><!-- /.thm-btn cta-two__btn -->
            ...
            <div class="container">
                <div class="video-one__box wow fadeInUp" data-wow-duration="1500ms">
                    ...
                    <div class="video-one__content">
                        <a href="https://www.youtube.com/watch?v=aitb---aDYM" class="video-popup"><i class="fa fa-play"></i></a>
