...
<body>
    ...
    <div class="page-wrapper">
        ...
        <div class="cta-three" id="aboutus">
                ...
                <div class="row justify-content-end">
                    <div class="col-lg-6">
                        <div class="cta-three__content">
                            <div class="block-title text-left" x>
...
endeavour, enabling us to fuel our dream of bringing better games to you.</p>
        ...
        <section class="app-shot-one" style="background-color:lightcyan;">
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="footer-widget footer-widget__about">
                                <a class="footer-widget__logo" href="index.html"><img src="assets/images/timuz_logo.png" width="105" alt="Awesome Image" /></a>
                                <p>
                                    The bond that we share at TIMUZ is
built purely on hard work, dedication,
collaboration, passion, humility, and
respect. 
                                </p>
                                <p><a href="mailto:needhelp@zimed.com">nagatimuz@gmail.com</a> <br /> <a href="tel:666-888-0000">1234567890</a></p>
                            </div><!-- /.footer-widget -->
                        </div><!-- /.col-lg-4 -->
                        <div class="col-lg-4">
